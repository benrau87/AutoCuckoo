...
declare -a packages=(autoconf autogen automake bison flex yara libfuzzy-dev libmagic-dev libgeoip-dev libconfig-dev libjansson-dev shtool python-pip oracle-java8-installer elasticsearch mongodb-org python python-sqlalchemy python-bson python-dpkt python-jinja2 python-magic python-pymongo python-libvirt python-bottle python-pefile python-chardet swig libssl-dev clamav clamav-daemon clamav-freshclam python-geoip geoip-database mono-utils wkhtmltopdf xvfb xfonts-100dpi tcpdump libtool libcap2-bin virtualbox suricata p7zip-full unzip);
install_packages ${packages[@]}
...
rm /etc/cuckoo-modified/data/yara/binaries/APT_Shamoon*.yar  &>> $logfile
